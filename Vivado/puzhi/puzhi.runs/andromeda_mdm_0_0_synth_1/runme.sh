...
HD_PWD='/home/malik/andromeda_ila/AXI-DPE-simulation/AXI-Dot-Product-Accelerator/Vivado/puzhi/puzhi.runs/andromeda_mdm_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andromeda_mdm_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andromeda_mdm_0_0.tcl
