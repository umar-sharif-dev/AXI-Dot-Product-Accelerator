...
HD_PWD='/home/malik/andromeda_ila/andromeda/Vivado/puzhi/puzhi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andromeda_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andromeda_wrapper.tcl
