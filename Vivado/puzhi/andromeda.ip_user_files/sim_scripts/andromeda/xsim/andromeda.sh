...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L microblaze_v11_0_14 -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L iomodule_v3_1_11 -L util_vector_logic_v2_0_4 -L axi_lite_ipif_v3_0_4 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_37 -L axi_timer_v2_0_35 -L xlconstant_v1_1_9 -L smartconnect_v1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L axi_vip_v1_1_19 -L mdm_v3_2_27 -L gigantic_mux -L xlconcat_v2_1_6 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot andromeda xil_defaultlib.andromeda xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim andromeda -key {Behavioral:sim_1:Functional:andromeda} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_828f.protoinst" -protoinst "protoinst_files/bd_98e1.protoinst" -protoinst "protoinst_files/bd_85fa.protoinst" -protoinst "protoinst_files/andromeda.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/opt/tools/Xilinx/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb andromeda.wdb xsim.dir libdpi.so)
