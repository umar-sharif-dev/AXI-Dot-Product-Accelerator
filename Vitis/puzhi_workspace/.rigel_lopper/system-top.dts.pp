#line 1 "../puzhi_mb_platform/hw/sdt/system-top.dts"
/dts-v1/;
#line 1 "../puzhi_mb_platform/hw/sdt/pl.dtsi"
/ {
	...
	amba_pl: amba_pl {
		...
		#address-cells = <1>;
		#size-cells = <1>;
		axi_dpe_0: axi_dpe@30000 {
			xlnx,rable = <0>;
			compatible = "xlnx,axi-dpe-1.0";
			status = "okay";
			xlnx,ip-name = "axi_dpe";
		...
		axi_uartlite_0: serial@40600000 {
			...
			xlnx,s-axi-aclk-freq-hz-d = <0x13dcfdd0>;
			xlnx,rable = <0>;
		...
		sd_controller_wrapper_0: sd_controller_wrapper@20000 {
			xlnx,rable = <0>;
			compatible = "xlnx,sd-controller-wrapper-1.0";
			status = "okay";
			xlnx,ip-name = "sd_controller_wrapper";
			xlnx,edk-iptype = "PERIPHERAL";
			reg = <0x00020000 0x1000>;
			xlnx,simulation = <0>;
			xlnx,name = "sd_controller_wrapper_0";
		};
	};
};
#line 3 "../puzhi_mb_platform/hw/sdt/system-top.dts"
/ {
	device_id = "xcku5p";
	#address-cells = <1>;
	#size-cells = <1>;
	...
	cpus_microblaze_0: cpus_microblaze@0 {
		address-map = <0x80000000 &ddr4_0_memory 0x80000000 0x80000000>,
			      ...
			      <0x00020000 &sd_controller_wrapper_0 0x00020000 0x1000>,
			      <0x00030000 &axi_dpe_0 0x00030000 0x10000>,
